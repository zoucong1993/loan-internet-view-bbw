...
function getElCoordinate(dom) {
    ...
    /*while (dom) {
     ...
     if(className === 'el-dialog'){
     var offset = $('.el-dialog').position()
     t += offset.left;
     l += offset.top;
     break
     }
...
if (!Date.prototype.format && typeof Date.prototype.format !== 'function') {
...
function eventMixin(GFlow) {
    GFlow.prototype.on = function (type, fn) {
    ...
    GFlow.prototype.once = function (type, fn) {
        var context = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this;
    ...
    GFlow.prototype.off = function (type, fn) {
    ...
    GFlow.prototype.trigger = function (type) {
...
//初始化区域图的对象
    ...
    if (property.haveHead) {
        ...
        var preDefine = ["new", "open", "save", "undo", "redo", "reload", "print"];
        let tips = {
            "undo": "撤销",
            "redo": "恢复",
            "el-icon-download": "下载",
        ...
        for (var x = 0; x < property.headBtns.length; ++x) {
            if (preDefine.indexOf(property.headBtns[x]) !== -1) {
                theIcon = "ico_" + property.headBtns[x]
            } else {
                theIcon = property.headBtns[x]
            }
            tmp += "<a href='javascript:void(0)' title='" + tips[property.headBtns[x]] + "' class='GooFlow_head_btn'><i class='" + theIcon + "'></i></a>"
        }
        tmp += "</div>";
        this.$head = $(tmp);
        ...
        if (property.headBtns)
            this.$head.on("click", {inthis: this}, function (e) {
                ...
                var className = $(tar).attr("class").replace(/^ico_/, '');
                ...
                /*var This=e.data.inthis;
                 ...
                 case "el-icon-download": if(This.onDownload!=null)	This.onDownload();break;
                 case "el-icon-delete": if(This.onDelete!=null)	This.onDelete();break;
                 case "el-icon-share": if(This.onExport!=null)	This.onExport();break;
                 }*/
    ...
    if (this.$editable) {
        ...
        this.$workArea.append(this.$lineMove).append(this.$textArea).append(this.$ghost);
...
GooFlow.prototype = {
            ...
            this.$group.on("mousedown",{inthis:this},function(e){//绑定RESIZE功能以及移动功能
                ...
                if(cursor!="move"){
                    This.$ghost.css({display:"block",
                        ...
                        top:This.$areaData[id].top-This.$workArea[0].parentNode.scrollTop+"px",
                        left:This.$areaData[id].left-This.$workArea[0].parentNode.scrollLeft+"px",cursor:cursor});
                ...
                document.onmousemove=function(e){
                    ...
                    var ev=mousePosition(e);
                    if(cursor!="move"){
                        X=ev.x+This.$workArea[0].parentNode.scrollLeft-This.$areaData[id].left+vX;
                        Y=ev.y+This.$workArea[0].parentNode.scrollTop-This.$areaData[id].top+vY;
                        if(X<200)	X=200;
                        if(Y<100)	Y=100;
                        switch(cursor){
                        ...
                        if(X < 0){
                            X = 0;
                        }else if(X > This.$workArea[0].clientWidth - This.$nodeData[id].width){
                            X = This.$workArea[0].clientWidth - This.$nodeData[id].width
                        }
                        if(Y < 0){
                            Y = 0;
                        }else if(Y > This.$workArea[0].clientHeight - This.$nodeData[id].height){
                            Y = This.$workArea[0].clientHeight - This.$nodeData[id].height
                        }
                ...
                document.onmouseup=function(e){
                    ...
                    if(cursor!="move")
                        ...
                        This.moveArea(id,X+This.$workArea[0].parentNode.scrollLeft,Y+This.$workArea[0].parentNode.scrollTop);
                    return false;
                }
            });
            //绑定修改文字说明功能
    ...
    addNode: function (id, json) {
        ...
        if (json.type.indexOf(" round") < 0) {
            ...
            json.width = 26;
            json.height = 26;
            // json.top = json.top -F json.height/2;
            // json.left = json.left - json.width/2;
    ...
    initWorkForNode: function () {
        ...
        this.$workArea.delegate(".ico", "mousedown", {inthis: this}, function (e) {
            ...
            var X, Y;
            X = ev.x + This.$workArea[0].parentNode.scrollLeft;
            Y = ev.y + This.$workArea[0].parentNode.scrollTop;
            ...
            document.onmousemove = function (e) {
                ...
                if (isMove && This.$ghost.css("display") == "none") {
                    This.$ghost.css({
                        ...
                        top: This.$nodeData[id].top - This.$workArea[0].parentNode.scrollTop + "px",
                        left: This.$nodeData[id].left - This.$workArea[0].parentNode.scrollLeft + "px", cursor: "move"
                    });
                }
            ...
            document.onmouseup = function (e) {
                if (isMove) This.moveNode(id, X + This.$workArea[0].parentNode.scrollLeft, Y + This.$workArea[0].parentNode.scrollTop);
                This.$ghost.empty().hide();
                document.onmousemove = null;
                document.onmouseup = null;
            }
        ...
        /*this.$workArea.delegate(".GooFlow_item > .span","dblclick",{inthis:this},function(e){
            ...
            This.$textArea.val(oldTxt).css({display:"block",height:$(this).height()+6,width:100,
                left:This.$nodeData[id].left-This.$workArea[0].parentNode.scrollLeft-26,
        ...
        this.$workArea.delegate(".ico + td","dblclick",{inthis:this},function(e){
            ...
            This.$textArea.val(oldTxt).css({display:"block",width:$(this).width()+26,height:$(this).height()+6,
                left:This.$nodeData[id].left-This.$workArea[0].parentNode.scrollLeft,
                top:This.$nodeData[id].top-This.$workArea[0].parentNode.scrollTop})
                .data("id",This.$focus).focus();
            This.$workArea.parent().one("mousedown",function(e){
                if(e.button==2)return false;
                This.setName(This.$textArea.data("id"),This.$textArea.val(),"node");
        ...
        this.$workArea.delegate(".GooFlow_item > div > div[class!=rs_close]", "mousedown", {inthis: this}, function (e) {
            ...
            This.$ghost.css({
                ...
                width: This.$nodeData[id].width + "px", height: This.$nodeData[id].height + "px",
                top: This.$nodeData[id].top - This.$workArea[0].parentNode.scrollTop + "px",
                left: This.$nodeData[id].left - This.$workArea[0].parentNode.scrollLeft + "px", cursor: cursor
            });
            var X, Y;
            X = ev.x - t.left + This.$workArea[0].parentNode.scrollLeft;
            Y = ev.y - t.top + This.$workArea[0].parentNode.scrollTop;
...
function exportDiagramMixin(GFlow) {
    GFlow.prototype.exportDiagram = function (fileName) {
        //0.添加临时元素
        var width = this.$workArea.width();
        var height = this.$workArea.height();
        $("body").append('<div id="view_export" style="position:absolute;top:0;left:0;z-index:-1;width:0px;height:0px;overflow:hidden">'
        ...
        var divCanvas = $("#view_export").children("div:eq(0)");
        var svgEle = this.$bgDiv.find('svg');
        //复制节点的内容
        ...
        html2canvas(divCanvas[0], {
            ...
            onrendered: function (canvas) {
                ...
                var strSvg = '<svg xmlns="http://www.w3.org/2000/svg" width="1160" height="507">'
                    ...
                    + '}</style></defs>' + window.$("<svg>").append(svgEle.clone()).html() + '</svg>'; //COPY连线内容
                var image = null;
...
eventMixin(GooFlow);
exportDiagramMixin(GooFlow);

export default function createGooFlow(bgDiv, property) {
