<template>
    <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
        <el-tab-pane label="业务信息" name="apply">
            <risk-class-adjust-info :rowData="rowData"></risk-class-adjust-info>
        </el-tab-pane>
...
<script>
    ...
    import RiskClassAdjustInfo from "~/views/pls/risk/riskClassAdjust/riskClassAdjustInfo";

    export default {
        name: 'contentTab',
        components: {RiskClassAdjustInfo, todoForm, doneFrom, procView, pdfView},
        props: {
            rowData: Object,
            flag: {
                type: String,
