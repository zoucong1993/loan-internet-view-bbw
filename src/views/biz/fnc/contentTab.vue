<template>
    <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
        <el-tab-pane label="业务信息" name="apply">
            <account-info :rowData="rowData"></account-info>
        </el-tab-pane>
        <el-tab-pane label=":span="8"表单" name="todo" v-if="flag === 'todo'">
...
<script>
    ...
    import AccountInfo from "~/views/biz/fnc/accountInfo";


    export default {
        name: 'contentTab',
        components: {AccountInfo, todoForm, doneFrom, procView, pdfView},
        props: {
            rowData: Object,
            flag: {
                type: String,
