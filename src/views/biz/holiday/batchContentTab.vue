<template>
    <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
        <el-tab-pane label="业务信息" name="apply">
            <holiday-batch-info :rowData="rowData"></holiday-batch-info>
        </el-tab-pane>
...
<script>
    ...
    import HolidayBatchInfo from "~/views/biz/holiday/holidayBatchInfo";

    export default {
        name: "batchContentTab",
        components: {HolidayBatchInfo, todoForm, doneFrom, procView, pdfView},
        props: {
            rowData: Object,
            flag: {
                type: String,
