    ...
    <div>
        ...
        <el-card class="box-card" shadow="never">
            ...
            <el-dialog
                    ...
                    append-to-body
                    width="30%">
                <prdOrgRel-add ref="prdOrgRelAddForm" @refreshTable="searchItem" :prdCode="this.productNo"
                               @addPrdOrgRelDialog="closeDialog"></prdOrgRel-add>
                <div slot="footer" class="dialog-footer" style="text-align:center;">
                    <el-button type="primary" @click="submitForm('prdOrgRelAddForm')">确 定</el-button>
            ...
            <el-dialog
                    ...
                    append-to-body
                    width="30%">
                <prdOrgRel-update ref="prdOrgRelUpdateForm" @refreshTable="refresh" @updatePrdOrgRelDialog="closeDialog"
                                  :row="row" :operate="operate1"></prdOrgRel-update>
                <div v-if='this.operate1 === "update"' slot="footer" class="dialog-footer" style="text-align:center;">
                    <el-button type="primary" @click="submitForm('prdOrgRelUpdateForm')">确 定</el-button>
...
<script>
    import prdOrgRelAdd from './prdOrgRelAdd';
    import prdOrgRelUpdate from './prdOrgRelUpdate';

    export default {
        name: "prdOrgRelList",
        components: {
            "prdOrgRel-add": prdOrgRelAdd,
            "prdOrgRel-update": prdOrgRelUpdate
        },
        props: {
            operate: String,
            productNo: String
        ...
        data() {
            return {
                url: "/loan/prdOrgRelAction.do?_md=findPrdOrgRelList",
                ...
                columns: [{
                    ...
                    prop: "includeType",
                    label: "包含关系"
                    // selectKey: 'STD_ZB_MARITAL_STATUS'
                }, {
                    prop: "curVers",
                    label: "版本信息"
                }],
            ...
            deleteItem: function () {
                ...
                if (rows.length === 1) {
                    this.$confirm("是否删除此条数据？", "温馨提示", {
                        ...
                        _this.$http.post("/loan/prdOrgRelAction.do?_md=deletePrdOrgRelById", {id: rows[0].id})
